...
1.The pitch of the camera angle wasn't always 180 degrees so over time it would make the player turn and go back a bit which would get it stuck onto blocks
## Fix 
